...
if __name__ == '__main__':
    ...
    image_height = 256
    image_width  = 256
    path         = "../face3dMM/examples/Data/BFM/Out/BFM_RAW.mat"
    pth          = '/home/karim/Desktop/'
    imgs         = [pth + 'face_1.png', pth + 'face_1.png', pth + 'face_2.png', pth + 'face_3.png', pth + 'face_4.png', pth + 'face_5.png', pth + 'face_6.png', pth + 'face_7.png',  pth + 'face_8.png']
    
    #pth          = '/home/karim/Desktop/test/'
    #imgs         = [pth + '35.png', pth + '12.png', pth + '30.png', pth + '29.png', pth + '16.png', pth + '17.png', pth + '18.png',  pth + '19.png']
    ...
    landmarks_weights[:6]    = 0.2 # left cheeck
    landmarks_weights[10:17] = 0.2 # right cheeck
    ...
    #landmarks_weights[61:64] = 1.0 # upper inner mouth
    #landmarks_weights[67:66] = 1.0 # lower inner mouth


    #landmarks_weights[60]    = 0.0 # left innder-lip
    #landmarks_weights[64]    = 0.0 # right inner-lip
    ...
    reg_loss       = tf.reduce_sum(tf.square(albedo)) + 1.2 * tf.reduce_sum(tf.square(identity)) + tf.reduce_sum(tf.square(expressions))

    # Pose optimizer
    pose_loss = landmarks_loss + 5e1 * reg_loss # BFM09
    ...
    loss = 1.1 * pixel_loss + 2.5e-3 * landmarks_loss + 3e-8 * reg_loss #BFM09, Batch 8

    global_step = tf.train.get_or_create_global_step()
    decay_learning_rate = tf.train.exponential_decay(0.01, global_step, 400, 0.8, staircase=True)
