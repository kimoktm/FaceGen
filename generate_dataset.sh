...
python test_render_faceware.py --output '/home/karim/Documents/Development/FacialCapture/face3dMM/examples/results/faces/del' \
						          --samples 100


# echo 'Generating training set:'
# python test_render.py --output '/home/karim/Documents/Development/FacialCapture/face3dMM/examples/results/faces/funcspace_test_norm/train' \
# 						          --samples 5000


# echo 'Generating validation set:'
# python test_render.py --output '/home/karim/Documents/Development/FacialCapture/face3dMM/examples/results/faces/funcspace_test_norm/validation' \
